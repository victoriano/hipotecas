              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-left text-gray-600 border-b">
                    ...
                    <th className="py-2 pr-2">Ahorro mensual</th>
                    <th className="py-2 pr-2">Ahorro anual</th>
                    <th className="py-2 pr-2">Ahorro neto anual</th>
                    <th className="py-2 pr-2">Ahorro neto 30 años</th>
                  </tr>
                </thead>
                <tbody>
                  {rows.map(({ b, newRate, newPayment, monthlySaving, annualSaving, netAnnual, net30y }) => (
                    <tr key={b.id} className="group border-b last:border-0 hover:bg-gray-50">
                      ...
                      <td className={`py-2 pr-2 align-middle ${monthlySaving >= 0 ? "text-green-700" : "text-red-700"}`}>{eur(monthlySaving)}</td>
                      <td className={`py-2 pr-2 align-middle ${annualSaving >= 0 ? "text-green-700" : "text-red-700"}`}>{eur(annualSaving)}</td>
                      <td className={`py-2 pr-2 align-middle font-medium ${netAnnual >= 0 ? "text-green-700" : "text-red-700"}`}>{eur(netAnnual)}</td>
                      <td className={`py-2 pr-2 align-middle font-medium ${net30y >= 0 ? "text-green-700" : "text-red-700"}`}>{eur(net30y)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
